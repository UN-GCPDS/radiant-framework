...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('researchers', '0003_auto_20221103_2012'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='category',
            field=models.CharField(choices=[('researcher_category_0001', 'Investigador Asociado'), ('researcher_category_0002', 'Investigador Emérito'), ('researcher_category_0003', 'Investigador Junior'), ('researcher_category_0004', 'Investigador Senior'), ('researcher_category_0005', 'Sin información')], max_length=124, verbose_name='Category'),
        ),
        migrations.AlterField(
            model_name='professor',
            name='departament',
