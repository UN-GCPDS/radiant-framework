...
class MDCRangeSlider(MDCTemplate):
    ...
    # ----------------------------------------------------------------------
    def __new__(self, label, min_lower=0, max_lower=100, value_lower=0, min_upper=0, max_upper=100, value_upper=100, step=1, disabled=False, **kwargs):
        """"""
        self.element = self.render(locals(), kwargs)
        # self.element.need_label = False
    ...
    def __html__(cls, **context):
        ...
        code = """
            <div class="mdc-slider mdc-slider--range {disabled}">
              <input class="mdc-slider__input" {input_disabled} type="range" min="{min_lower}", step="{step}" max="{max_lower}" value="{value_lower}" name="rangeStart-{id}" aria-label="Range lower slider demo">
              <input class="mdc-slider__input" {input_disabled} type="range" min="{min_upper}", step="{step}" max="{max_upper}" value="{value_upper}" name="rangeEnd-{id}" aria-label="Range upper slider demo">
              <div class="mdc-slider__track">
                <div class="mdc-slider__track--inactive"></div>
                <div class="mdc-slider__track--active">
